...
- `Landing.tsx`, `Quiz.tsx`, `BrowseCoffees.tsx`, `CoffeeDetail.tsx`, `RateCoffee.tsx`, `RatingDial.tsx`, `Journal.tsx`, `TaxonomyView.tsx`, `AddAndRateFlow.tsx` — the views above. (`AddCoffeeForm.tsx` was deleted July 5, 2026 — dead code absorbed by `AddAndRateFlow`.)
